<?php
/**
 * Messing Around functions and definitions
 *
...
if ( ! function_exists( 'messingaround_setup' ) ) :
	 ...
	 */
	function messingaround_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Messing Around, use a find and replace
		 * to change 'messingaround' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'messingaround', get_template_directory() . '/languages' );
		...
		add_image_size( 'messingaround-full-bleed', 2000, 1200, true);
		add_image_size( 'messingaround-index-img', 800, 450, true);
		...
		add_theme_support( 'custom-background', apply_filters( 'messingaround_custom_background_args', array(
 ...
 */
function messingaround_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'messingaround_content_width', 640 );
}
add_action( 'after_setup_theme', 'messingaround_content_width', 0 );
 ...
 */
function messingaround_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'messingaround' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'messingaround' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Widgets', 'messingaround' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Add footer widgets here.', 'messingaround' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Page Sidebar', 'messingaround' ),
		'id'            => 'sidebar-3',
		'description'   => esc_html__( 'Add page widgets here.', 'messingaround' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
add_action( 'widgets_init', 'messingaround_widgets_init' );
...
function messingaround_scripts() {
	...
	wp_enqueue_script( 'messingaround-navigation', get_template_directory_uri() . '/js/navigation.js', array('jquery'), '20151215', true );
	wp_localize_script( 'messingaround-navigation', 'messingaroundScreenReaderText', array(
		'expand' => __( 'Expand child menu', 'messingaround'),
...
add_action( 'wp_enqueue_scripts', 'messingaround_scripts' );
